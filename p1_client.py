    ...
    with open(output_file_path, 'wb') as file:
        while True:
            ...
            try:
                ...
                # logging.info(f'received data is {data} and seq is {seq_num} and expected seq is {expected_seq_num}')
                # logging.getLogger().handlers[0].flush()
                ...
                if rand_num>11:
                    ...
                    if seq_num == expected_seq_num:
                        ...
                        send_ack(client_socket, server_address, seq_num,time_stamp)
...
#     """
#     # print(packet.decode())
#     seq_num, data, time_stamp = packet.split(b'|')
#     return int(seq_num), data, time_stamp

# def send_ack(client_socket, server_address, seq_num, time_stamp):
#     """
#     Send a cumulative acknowledgment for the received packet.
#     """
#     ack_packet = f"{seq_num}|{time_stamp.decode()}|ACK".encode()
#     client_socket.sendto(ack_packet, server_address)
#     #print(f"Sent cumulative ACK {seq_num} and ack is {seq_num}|ACK")
